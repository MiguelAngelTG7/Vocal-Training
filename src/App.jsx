		...
		<div className="bg-dark text-light min-vh-100">
			<nav className="navbar navbar-dark bg-dark border-bottom mb-5">
				<div className="container-fluid">
					<div
						className="display-3 fw-bold w-100 text-center mb-2"
			...
			{showMenu && (
				<div
					className="sidebar-menu bg-dark text-light position-fixed h-100"
					style={{
						width: "260px",
						top: 0,
						left: 0,
					...
					<div className="p-2">
						<ul className="list-group list-group-flush">
							{sections.map((section) => (
								<li
									key={section.id}
									className={`list-group-item list-group-item-action bg-dark text-light duolingo-font`}
			...
			<main className="container">
				...
				<section className="mb-5">
					<h2 className="display-5 fw-bold text-center mb-5 duolingo-font text-info">
						📅 DÍA 1 – CANTANDO
					</h2>
							...
							<div className="col-md-6 col-lg-4" key={card.title + idx}>
								<div className="card bg-secondary text-light shadow duolingo-card h-100">
									<div className="card-body duolingo-card-body">
										<h5 className="card-title fs-4 fw-bold duolingo-font mb-3">
											{idx + 1}. {card.title}
										</h5>
